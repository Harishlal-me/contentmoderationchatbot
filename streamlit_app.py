    ...
    with h2:
        if st.session_state.history:
            ...
            st.download_button(
                label="📥 Download CSV",
                data=csv,
                file_name=f'cyberguard_log_{datetime.now().strftime("%Y%m%d_%H%M%S")}.csv',
                mime='text/csv',
                key='download-csv'
            )
...
def page_about():
    st.markdown('<div class="animate-enter">', unsafe_allow_html=True)
    st.markdown('<h2 style="border-left: 4px solid #00f2ff; padding-left: 15px;">ℹ️ About the Research</h2>', unsafe_allow_html=True)
    
    st.markdown("""
    <div class="glass-card">
        <h3 style="background: linear-gradient(90deg, #00f2ff, #bc13fe); -webkit-background-clip: text; -webkit-text-fill-color: transparent;">
            BERT-Based Deep Learning for Social Media Safety
        </h3>
        <p style="font-size: 1.1rem; margin-top: 15px; line-height: 1.6;">
            This system represents a production-ready AI solution for detecting cyberbullying. 
            Developed as part of the <b>UROP 2025-26</b> program at <b>SRM Institute of Science and Technology</b>.
        </p>
        
        <div style="margin-top: 30px; display: grid; grid-template-columns: 1fr 1fr; gap: 20px;">
            <div>
                <h4 style="color: #00f2ff;">🎓 Research Project</h4>
                <p><b>Institution:</b> SRM Institute of Science and Technology, Kattankulathur</p>
                <p><b>Program:</b> UROP 2025-26 | Cybersecurity & Disruptive Technology</p>
                <p><b>Research Guide:</b> Dr. G. Balamurugan, Associate Professor</p>
                <p><b>Author:</b> Harishlal M.E. | B.Tech CSE (First Year)</p>
                <p style="font-size: 0.9rem; opacity: 0.7;">Industrial Experience: Software Testing Intern, Interain AI</p>
            </div>
            
            <div>
                <h4 style="color: #bc13fe;">🌟 Project Highlights</h4>
                <div style="margin-bottom: 10px;">
                    ...
                    <div style="display: flex; justify-content: space-between; border-bottom: 1px solid rgba(255,255,255,0.1); padding-bottom: 5px; margin-top: 5px;">
                        <span>⚖️ Balance</span>
                        <b>94.19% F1-Score</b>
                    </div>
                    <div style="display: flex; justify-content: space-between; border-bottom: 1px solid rgba(255,255,255,0.1); padding-bottom: 5px; margin-top: 5px;">
        ...
        <h4 style="color: #00ff80; margin-top: 20px;">💡 Why This Project Stands Out</h4>
        <div style="background: rgba(255,255,255,0.05); padding: 15px; border-radius: 12px; font-size: 0.9rem; line-height: 1.8;">
            ✅ <b>Publication-Quality Results</b> - 94.5% recall on safety-critical application<br>
            ✅ <b>Comprehensive Research</b> - Ablation study comparing Baseline vs Focal Loss<br>
            ✅ <b>Large-Scale Data</b> - 120,000+ examples from 4 integrated datasets<br>
            ✅ <b>Production Deployment</b> - Working web application with interactive UI<br>
            ✅ <b>Professional Code</b> - Clean architecture, documentation, reproducibility<br>
            ✅ <b>Error Analysis</b> - Detailed categorization of FP/FN with improvement strategies
        </div>
        
        <hr style="border-color: rgba(255,255,255,0.1); margin: 25px 0;">
        
        <h4 style="margin-bottom: 15px;">🛠 Technology Stack</h4>
        <div style="display: flex; gap: 10px; flex-wrap: wrap;">
            <span style="background: rgba(255,255,255,0.1); padding: 5px 15px; border-radius: 20px; font-size: 0.85rem;">Python 3.10</span>
            <span style="background: rgba(255,255,255,0.1); padding: 5px 15px; border-radius: 20px; font-size: 0.85rem;">PyTorch</span>
            <span style="background: rgba(255,255,255,0.1); padding: 5px 15px; border-radius: 20px; font-size: 0.85rem;">HuggingFace Transformers</span>
            <span style="background: rgba(255,255,255,0.1); padding: 5px 15px; border-radius: 20px; font-size: 0.85rem;">Streamlit</span>
            <span style="background: rgba(255,255,255,0.1); padding: 5px 15px; border-radius: 20px; font-size: 0.85rem;">Plotly</span>
        </div>
    </div>
    """, unsafe_allow_html=True)
    st.markdown('</div>', unsafe_allow_html=True)
